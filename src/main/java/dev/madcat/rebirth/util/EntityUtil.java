...
import dev.madcat.rebirth.mixin.mixins.*;
import java.util.*;
import java.text.*;
import java.math.*;
...
public class EntityUtil implements Util
{
    ...
    public static boolean getSurroundWeakness(final Vec3d pos, final int feetMine, final int render) {
        switch (feetMine) {
            case 1: {
                ...
                if (!BlockUtil.canBlockBeSeen((double)(raytrace.getX() - 2), (double)raytrace.getY(), (double)raytrace.getZ()) && Math.sqrt(EntityUtil.mc.player.getDistanceSq((double)(raytrace.getX() - 2), (double)raytrace.getY(), (double)raytrace.getZ())) > 3.0) {
                    return false;
                }
            ...
            case 3: {
                final BlockPos raytrace = new BlockPos(pos);
                if (!BlockUtil.canBlockBeSeen((double)raytrace.getX(), (double)raytrace.getY(), (double)(raytrace.getZ() - 2)) && Math.sqrt(EntityUtil.mc.player.getDistanceSq((double)raytrace.getX(), (double)raytrace.getY(), (double)(raytrace.getZ() - 2))) > 3.0) {
                    return false;
                }
            ...
            case 5: {
                ...
                if (!BlockUtil.canBlockBeSeen((double)(raytrace2.getX() - 1), (double)raytrace2.getY(), (double)raytrace2.getZ()) && Math.sqrt(EntityUtil.mc.player.getDistanceSq((double)(raytrace2.getX() - 1), (double)raytrace2.getY(), (double)raytrace2.getZ())) > 3.0) {
                    return false;
                }
            ...
            case 7: {
                final BlockPos raytrace2 = new BlockPos(pos);
                if (!BlockUtil.canBlockBeSeen((double)raytrace2.getX(), (double)raytrace2.getY(), (double)(raytrace2.getZ() - 1)) && Math.sqrt(EntityUtil.mc.player.getDistanceSq((double)raytrace2.getX(), (double)raytrace2.getY(), (double)(raytrace2.getZ() - 1))) > 3.0) {
                    return false;
                }
    ...
    public static boolean isntValid(final Entity entity, final double range) {
        return entity == null || isDead(entity) || entity.equals((Object)EntityUtil.mc.player) || (entity instanceof EntityPlayer && Rebirth.friendManager.isFriend(entity.getName())) || EntityUtil.mc.player.getDistanceSq(entity) > MathUtil.square(range);
    }
    ...
    public static Color getColor(final Entity entity, final int red, final int green, final int blue, final int alpha, final boolean colorFriends) {
        ...
        if (entity instanceof EntityPlayer && colorFriends && Rebirth.friendManager.isFriend((EntityPlayer)entity)) {
    ...
    public static Map<String, Integer> getTextRadarPlayers() {
        ...
        for (final EntityPlayer player : EntityUtil.mc.world.playerEntities) {
            if (!player.isInvisible()) {
                ...
                output.put(healthSB.toString() + " " + (Rebirth.friendManager.isFriend(player) ? ChatFormatting.AQUA : ChatFormatting.RED) + player.getName() + " " + distanceSB.toString() + " \u00c2��f0", (int)EntityUtil.mc.player.getDistance((Entity)player));
    ...
    public static Boolean posEqualsBlock(final BlockPos pos, final Block block) {
