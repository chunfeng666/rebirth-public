...
public class GlShader
{
    ...
    public GlShader(final InputStream sourceStream, final String name) {
        ...
        final int programId = this.programId = GL20.glCreateProgram();
        ...
        if (GL20.glGetProgrami(programId, 35714) == 0) {
            final String error = GL20.glGetShaderInfoLog(programId, 1024);
    ...
    public void set(final String uniformName, final Vec3d value) {
        GL20.glUniform3f(this.createUniform(uniformName), (float)value.x, (float)value.y, (float)value.z);
    }
    
    public void set(final String uniformName, final Vector3f value) {
        GL20.glUniform3f(this.createUniform(uniformName), value.x, value.y, value.z);
    }
    ...
    public static GlShader createShader(final String name) {
        final InputStream sourceStream = GlShader.class.getResourceAsStream("/shader/" + name);
        if (sourceStream == null) {
            return null;
        }
        String source;
