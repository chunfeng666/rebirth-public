...
public class AntiPackets extends Module
{
    ...
    public AntiPackets() {
        super("AntiPackets", "Blocks Packets and BookBan.", Category.MISC, true, false, false);
    ...
    public void onLeavingDeathEvent(final PacketEvent.Receive event) {
        ...
        event.isCancelled();
        AntiPackets.mc.player.openContainer.slotClick(packet.getSlotId(), packet.getUsedButton(), packet.getClickType(), (EntityPlayer)AntiPackets.mc.player);
    }
